...
$sql="UPDATE curso SET nombre_curso = '$nombres', creditos='$creditos' WHERE curso_id = '$curso_id'";
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <?php
                if (!$resultado)
                {
                    echo 'No se ha podido editar la información del curso';
                }
                else
                {
