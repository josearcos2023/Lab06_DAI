...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <h3>Editar Curso</h3>
            <div>
                <form name="formEditar" method="post" action="editar_curso_reg.php">
                    ...
                    <div>
                        <div class="col-3 mb-3">
                            <label for="nom_curso">Nombre de Curso</label><br>
                            <input type="text" class="form-control" name="nom_curso" id="nom_curso" value="" required>
                        </div>
                        <div class="col-3 mb-3">
