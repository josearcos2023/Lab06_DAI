...
$sql="UPDATE alumno SET nombres = '$nombres', ap_paterno='$ap_paterno', ap_materno='$ap_materno' WHERE alumno_id = '$alumno_id'";
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <?php
                if (!$resultado)
                {
                    echo 'No se ha podido editar la información del alumno';
                }
                else
                {
